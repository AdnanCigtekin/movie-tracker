...
class ListDirectors extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            directors: [],
        ...
        fetch("http://localhost:8080/movie/", {
            ...
            .then(response => {
                ...
                this.setState({
                    ...
                    this.componentDidMount()
                    console.log("users: " + this.state.directors)
                })
            })
            .catch(error => {
                console.error(error);
    ...
    componentDidMount() {
       ...
       // this.state.token = token;
        ...
        fetch("http://localhost:8080/director/search-all/", {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token
